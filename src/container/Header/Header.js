...
const Header = () => {
  const { text } = useTypewriter({
    words: [ "Frontend Engineer", "Backend Engineer", "Software Engineer"],
    loop: false,
    cursor: true,
    cursorStyle: "_",
    typeSpeed: 60,
  ...
  return (
    ...
    >
      <img src="https://res.cloudinary.com/techwithtols/image/upload/v1649624427/portfolio/latest-pic.png" alt="profile_bg" />
      <motion.img
